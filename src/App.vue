...
export default {
  ...
  created() {
    if (process.env.NODE_ENV !== "production") {
      // add config to window.ACC.config
      ...
      window.ACC = {
        config: {
          ...
          user: "anonymous",
          coopStore: "016001",
          cartguid: "fe3a4b7d-3b0c-43a1-8415-89674c48a092",
          authToken:
...
.o-start-module .header-module {
  display: flex;
  justify-content: space-between;
  width: 100%;
  position: relative;
}
.o-start-module .header-module .a-heading-1 {
...
.o-start-module .header-module .a-link {
  position: absolute;
  right: 0;
  z-index: 1;
  margin-top: -4px;
